...
<html>
    ...
    <body>
        ...
        <form action="DeleteProduct_emp" method="POST" enctype="multipart/form-data"> 
        <table> 
            <tr> 
                <td>Product ID:</td> 
        ...
        <br><br> 
        <input type="button" value="Return to Product" onclick="window.location.href='emp_maintain_product.jsp'" class="return-btn"/> 
        </form> 
                </div>
