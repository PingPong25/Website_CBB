<%-- 
    Document   : manager_input_empid
    Created on : 9 May 2024, 5:13:12 pm
    Author     : User
--%>
        ...
        <div class="box">
            <form action="editEmp.jsp" method="post">
                ...
                <input type="submit" value="Submit" id="sub"> <br>
                 <input type="button" value="Back" id="back" onclick="window.location.href='manager_maintain_emp.jsp'">
            </form>
        </div>
    </div>
    <div class="footer">
