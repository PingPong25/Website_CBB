...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="EditProduct_emp?PID=<%= productId%>">Edit</a></td>
                    <td><a href="DeleteProduct_emp?PID=<%= productId%>">Delete</a></td>
                </tr>
                <%
                    }
                %>
        ...
        <a href="emp_maintain_product.jsp" class="back-btn">Back</a>
