...
<body> 
    ...
    <div class="form-box"> <!-- Start of the box -->
        ...
        <form action="EditProduct_emp" method="POST" enctype="multipart/form-data"> 
            <table> 
                <tr> 
                    <td>Product ID:</td> 
            ...
            <input type="button" value="Return to Product" onclick="window.location.href='ViewProduct_emp.jsp'" class="return-btn" /> 
        </form> 
    </div> <!-- End of the box -->
