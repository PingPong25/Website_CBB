...
<%
    ...
    try {
        ...
        if (searchKey != null && !searchKey.isEmpty() && !searchKey.equals("Enter ID or Name")) {
            // Execute search query
            rs = stmt.executeQuery("SELECT * FROM PRODUCT WHERE LOWER(pname) LIKE '%" + searchKey.toLowerCase() + "%'");
            message = "Showing results for \"" + searchKey + "\"";
        } else {
            // If no search input provided, fetch all products
            rs = stmt.executeQuery("SELECT * FROM PRODUCT");
...
<body>
 ...
 <form method="get" action="">
        <input type="text" name="searchInput" placeholder="<%= searchKey %>">
...
<table border="1" style="text-align: center;">
    ...
    <tr>
        ...
        <td><a class="add-to-cart-btn" href="AddToCart_Cust?PID=<%= productId %>">Add To Cart</a></td>
    </tr>
    <% } %>
</table>
   ...
   <%-- Display comments here --%>
    ...
    out.println("</div>");
        ...
        <div class="submit-comment">
            <form id="commentForm" action="Feedback" method="post" onsubmit="return validateCommentForm()">
