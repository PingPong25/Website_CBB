...
@WebServlet(urlPatterns = {"/PaymentServlet_Emp"})
public class PaymentServlet_Emp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try { 
            ...
            if (nameOnCard == null || nameOnCard.trim().equals("")){
                errors.put("nameOnCard", "Please fill in the name of card.");
            }
            ...
            if (expiryDate == null || expiryDate.trim().equals("")){
                errors.put("expiryDate", "Please select a expiry date of your card.");
            }
            ...
            DA.addPayment(payment);
                ...
                response.sendRedirect("Rating_Emp.jsp");
