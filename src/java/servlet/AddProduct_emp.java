...
@WebServlet(name = "AddProduct_emp", urlPatterns = {"/AddProduct_emp"})
@MultipartConfig
public class AddProduct_emp extends HttpServlet {
...
//            saveImageToFile(imageInputStream, imagePath);
            ...
            if (errors.isEmpty()) {
                ...
                request.getRequestDispatcher("AddProduct_emp.jsp").forward(request, response);
            }
        } catch (Exception ex) {
