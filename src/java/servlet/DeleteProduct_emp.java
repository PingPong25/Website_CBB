...
@WebServlet(urlPatterns = {"/DeleteProduct_emp"})
@MultipartConfig
public class DeleteProduct_emp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("DeleteProduct_emp.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try { 
            ...
            if (errors.isEmpty()) {
                ...
                request.getRequestDispatcher("DeleteProduct_emp.jsp").forward(request, response);
            }
        } catch (Exception ex) {
